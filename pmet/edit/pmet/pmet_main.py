...
def apply_pmet_to_model(
    ...
    cache_template: Optional[str] = None,
     return_orig_weights_device: Optional[str] = None,  # 新增参数
    ...
    for i, layer in enumerate(hparams.layers):
        ...
        for rewrite_module_name in rewrite_module_names:
            ...
            cov = get_cov(
                ...
                mom2_batch_tokens=hparams.mom2_batch_tokens,  # 新增
            )
...
def get_cov(
    ...
    if key not in COV_CACHE or force_recompute:
        stat = layer_stats( # download
            ...
            force_recompute=force_recompute,
            batch_tokens=mom2_batch_tokens,  # 新增，控制显存
        )
